...
### Bagi Pengguna (Player & Server Owner)
...
- ** Panel Kontrol Lengkap**: Start, Stop, dan Restart kontainer server kapan saja langsung dari dasbor web.
...
- ** Sistem Tiket Bantuan**: Ajukan tiket bantuan langsung kepada Administrator sistem untuk kendala teknis atau pertanyaan seputar server.

### Bagi Administrator (System Admin)
...
- ** Resource Pool Management**: Atur batas maksimal kapasitas RAM global sistem. Pembelian paket baru akan otomatis dinonaktifkan apabila kapasitas server fisik telah mencapai batas maksimal (*sold out*).
...
```mermaid
graph TD
 User([Client / Browser]) -->|HTTP / 5173| Frontend[Frontend React App]
...
| ** Frontend App** | `apps/frontend` | `5173` | Dasbor pengguna & admin berbasis React 19, Vite, dan Tailwind CSS. |
...
- **[Panduan Deployment Production](file:///home/shinomiya/coding/projek/mcloud/docs/PRODUCTION_SETUP.md)** — Panduan resmi implementasi di server live (VPS/Cloud) lengkap dengan konfigurasi Docker, Nginx Reverse Proxy (SSL & WebSocket), PM2 Cluster, dan Midtrans Snap Production.
...
<div align="center">
 <p>Dibuat dengan untuk komunitas Minecraft Bedrock Indonesia.</p>
